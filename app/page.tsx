...
const sections = [
  {
    ...
    description:
      "Діагностика сильних і слабких сторін гри як одна з опцій у розділі навчання.",
    step: "01",
  },
  {
    href: "/trainer",
  ...
  },
  {
    ...
    title: "Навчання",
    description:
      "Уроки, теми, матеріали та окремий сценарій визначення рівня в одному просторі.",
    step: "03",
  },
] as const;
    ...
    <div className="mx-auto w-full max-w-6xl flex-1 px-4 py-14 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
          Партії з ботом, структуровані матеріали та визначення рівня всередині
          блоку навчання — у спокійному інтерфейсі для довгих сесій.
        </p>
      </div>
